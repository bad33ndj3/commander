...
// StartEngineArgs represents the command-line arguments for starting the engine
type StartEngineArgs struct {
	Quiet bool `flag:"quiet" default:"false" usage:"Start the engine in quiet mode"`
}

// ACArgs represents the command-line arguments for controlling the air conditioning
type ACArgs struct {
...
// HeatArgs represents the command-line arguments for controlling the heating system
